...
| J01-P3 | Producteur LibreOffice et validateur de paquet | T4 | ✅ | 1 | ids de note réservés `{-1,0,1}` (LO utilise 1 en séparateur) |
| J01-P4 | Instantané canonique et comparaison | T3 | ✅ | 1 | espace d'index = `story_root.iter(w:p)` (4e espace, ≠ locator V2) |
