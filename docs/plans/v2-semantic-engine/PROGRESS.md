...
## J03 — Migration des outils existants sur le cœur (9/11)
...
| J03-P8 | Review J03 | T2 | 🔄 | 1 | depends_on étendu à J03-P9, J03-P10, J03-P11 ; relit aussi J02-P10 |
...
- Ready: J03-P11 (CHANGELOG, T5, `files: [CHANGELOG.md]`) — à lancer en premier ; la revue J03-P8 (T2, tourne seule) en dépend et relit aussi J02-P10 et le CHANGELOG. Puis, si la revue est sans finding bloquant, merge de `v2-semantic-engine` sur `main` (D-014) avant d'ouvrir J04.
