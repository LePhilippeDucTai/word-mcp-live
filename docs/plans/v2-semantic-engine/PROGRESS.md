...
| J03-P5 | Opérations destructrices : TOC, en-têtes, suppression, signets, blocs | T3 | 🔄 | 2 | s4 coupée en vol : aucun commit sur `worktree-J03-P5`, 775 insertions non commitées sauvées en `/tmp/wml-recovery/J03-P5-try1.patch` (non vérifiées) |
